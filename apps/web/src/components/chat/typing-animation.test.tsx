...
describe('TypingAnimation', () => {
  ...
  it('progressively types out the text', () => {
    render(<TypingAnimation text="Hi" typingSpeed={50} />);
  ...
  it('hides cursor when complete and loop is false', async () => {
    render(<TypingAnimation text="Hi" typingSpeed={50} loop={false} />);
  ...
  it('keeps cursor visible when loop is true', () => {
    render(<TypingAnimation text="Hi" typingSpeed={50} loop={true} />);
  ...
  it('calls onComplete when typing finishes', () => {
    ...
    render(<TypingAnimation text="Hi" typingSpeed={50} loop={false} onComplete={onComplete} />);
