...
None of this requires assuming bad faith. Safety monitoring, abuse prevention, and model improvement are real needs. But a system that promises not to read your data and a system that _can't_ read your data are different things. One requires you to trust the company. The other is a property of the system itself.
