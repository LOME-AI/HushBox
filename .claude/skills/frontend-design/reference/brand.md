...
One caveat: committed is not reflex. HushBox's identity (the warm paper, the serif voice, the single brand red) is a deliberate commitment, not a default to escape. "Go big" pushes new choices toward distinctiveness; it never licenses sanding a committed identity toward something less strange or more common.
