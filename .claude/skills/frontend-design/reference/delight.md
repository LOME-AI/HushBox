...
**Animation**:
- Motion for orchestrated, React-stateful animation (entrances, exits, gesture-driven sequences, spring physics)
- CSS animations and the View Transitions API for cheap native motion (hovers, pulses, route and theme morphs)
- Gate all of it through the project's motion-aware helper so it no-ops under reduced or stopped motion
