...
**CRITICAL**: If no design system exists, STOP and use the AskUserQuestion tool (or ask the user directly in chat) to clarify before creating one. Understand the preferred location and structure first.
