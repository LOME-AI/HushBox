...
If a `DESIGN.md` already exists, **do not silently overwrite it**. Show the user the existing file and STOP and use the AskUserQuestion tool (or ask the user directly in chat) to clarify whether to refresh, overwrite, or merge.
