const ANTIPATTERNS = [
  ...
  },
  {
    ...
    description:
      'Five or more em-dashes (or "--") in body copy is an AI-cadence heuristic, not the absolute rule. HushBox bans long dashes in user-facing copy (enforced on rendered copy by the review subagent); this static pass only flags machine-cadence overuse. Use commas, colons, periods, or parentheses.',
    skillSection: 'Copy',
    skillGuideline: 'avoid em-dash overuse',
  },
  {
